...
class xljs3Spider(scrapy.Spider):
    logger_util = LoggerUtil()
    logger = logger_util.getSelfLogger("xljs3Spider")

    name = 'xljspl3'
    allowed_domains = ['mil.news.sina.com.cn',"comment.sina.com.cn"]

    start_urls = ["http://mil.news.sina.com.cn/roll/index.d.html?cid=234399"]
